...
interface Email {
  ...
  fromEmail: string;
  subject: string;
  threadId: number; // Ensure this matches the type used in MainPage
}
...
function AllInbox({ data, loadMail }: AllInboxProps) {
...
function Mail({ fromEmail, subject, threadId, loadMail }: MailProps) {
